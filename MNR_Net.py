...
class Detector:
    ...
    def forwardMultiStage(self, img, itr):
        ...
        t2 = time.time()
        print('14: '+str(t2-t1), end=', ')
        endT = time.time()
        print('T: '+str(endT-startT), end=', ')
        print('')
